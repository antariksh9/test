	...
	var BaseView = Backbone.View,
		...
		AddMemberFormView = BaseView.extend({
			...
			render: function() {
				...
				$(div)
					.find("div#overlay-initial-member div#form-head div#cross")
					.on("click", window.functions.addEventsButtons);
				$(div)
					.find("div#overlay-initial-member div#form-foot a#cancel-project")
					.on("click", window.functions.addEventsButtons);
				$(div)
					.find("div#overlay-initial-member div#form-foot a#create-new-project")
					.on("click", submitMemberFormData);
				$el.append($(div)
					.find("div#overlay-initial-member"));
				return _this;
			}
